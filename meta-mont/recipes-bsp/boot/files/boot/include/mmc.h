...
#define CONFIG_MMC_UHS
//#define CONFIG_MMC_SUPPORT_SDR104
//#define CONFIG_MMC_SUPPORT_DDR50
...
#define MMC_MODE_UHS_SDR12  0x00010000
#define MMC_MODE_UHS_SDR25  0x00020000
#define MMC_MODE_UHS_SDR50  0x00040000
#define MMC_MODE_UHS_SDR104 0x00080000
#define MMC_MODE_UHS_DDR50  0x00100000
#define MMC_MODE_MMC_HS200  0x00200000
...
struct mmc_ops
{
    ...
    void (*enable_preset_value) (struct mmc * mmc, int enable);
#endif
};
...
#define MMC_SIGNAL_VOLTAGE_180  1
    ...
    int (*block_write) (int dev_num, u32 start, u32 blkcnt, const void *src);
    int (*block_erase) (int dev_num, u32 start, u32 blkcnt);
};
