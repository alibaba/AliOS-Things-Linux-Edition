...
# 1 "/workplace3/panther.git/panther/linux-4.4//"
# 1 "<command-line>"
...
# 1 "/opt/montage.panther/toolchain-mips_interaptiv_gcc-4.8-linaro_uClibc-0.9.33.2/lib/gcc/mips-openwrt-linux-uclibc/4.8.3/include/stdarg.h" 1 3 4
# 40 "/opt/montage.panther/toolchain-mips_interaptiv_gcc-4.8-linaro_uClibc-0.9.33.2/lib/gcc/mips-openwrt-linux-uclibc/4.8.3/include/stdarg.h" 3 4
typedef __builtin_va_list __gnuc_va_list;
# 98 "/opt/montage.panther/toolchain-mips_interaptiv_gcc-4.8-linaro_uClibc-0.9.33.2/lib/gcc/mips-openwrt-linux-uclibc/4.8.3/include/stdarg.h" 3 4
...
static inline __attribute__((always_inline)) __attribute__((no_instrument_function)) void fdt_set_magic(void *fdt, uint32_t val) { struct fdt_header *fdth = (struct fdt_header*)fdt; fdth->magic = (( __be32)(__u32)(val)); };
static inline __attribute__((always_inline)) __attribute__((no_instrument_function)) void fdt_set_totalsize(void *fdt, uint32_t val) { struct fdt_header *fdth = (struct fdt_header*)fdt; fdth->totalsize = (( __be32)(__u32)(val)); };
static inline __attribute__((always_inline)) __attribute__((no_instrument_function)) void fdt_set_off_dt_struct(void *fdt, uint32_t val) { struct fdt_header *fdth = (struct fdt_header*)fdt; fdth->off_dt_struct = (( __be32)(__u32)(val)); };
static inline __attribute__((always_inline)) __attribute__((no_instrument_function)) void fdt_set_off_dt_strings(void *fdt, uint32_t val) { struct fdt_header *fdth = (struct fdt_header*)fdt; fdth->off_dt_strings = (( __be32)(__u32)(val)); };
static inline __attribute__((always_inline)) __attribute__((no_instrument_function)) void fdt_set_off_mem_rsvmap(void *fdt, uint32_t val) { struct fdt_header *fdth = (struct fdt_header*)fdt; fdth->off_mem_rsvmap = (( __be32)(__u32)(val)); };
static inline __attribute__((always_inline)) __attribute__((no_instrument_function)) void fdt_set_version(void *fdt, uint32_t val) { struct fdt_header *fdth = (struct fdt_header*)fdt; fdth->version = (( __be32)(__u32)(val)); };
static inline __attribute__((always_inline)) __attribute__((no_instrument_function)) void fdt_set_last_comp_version(void *fdt, uint32_t val) { struct fdt_header *fdth = (struct fdt_header*)fdt; fdth->last_comp_version = (( __be32)(__u32)(val)); };
static inline __attribute__((always_inline)) __attribute__((no_instrument_function)) void fdt_set_boot_cpuid_phys(void *fdt, uint32_t val) { struct fdt_header *fdth = (struct fdt_header*)fdt; fdth->boot_cpuid_phys = (( __be32)(__u32)(val)); };
static inline __attribute__((always_inline)) __attribute__((no_instrument_function)) void fdt_set_size_dt_strings(void *fdt, uint32_t val) { struct fdt_header *fdth = (struct fdt_header*)fdt; fdth->size_dt_strings = (( __be32)(__u32)(val)); };
static inline __attribute__((always_inline)) __attribute__((no_instrument_function)) void fdt_set_size_dt_struct(void *fdt, uint32_t val) { struct fdt_header *fdth = (struct fdt_header*)fdt; fdth->size_dt_struct = (( __be32)(__u32)(val)); };
...
# 13 "./arch/mips/include/asm/unaligned.h"
...
# 14 "./arch/mips/include/asm/unaligned.h" 2
...
static inline __attribute__((always_inline)) __attribute__((no_instrument_function)) u16 __get_unaligned_le16(const u8 *p)
{
 return p[0] | p[1] << 8;
}

static inline __attribute__((always_inline)) __attribute__((no_instrument_function)) u32 __get_unaligned_le32(const u8 *p)
{
 return p[0] | p[1] << 8 | p[2] << 16 | p[3] << 24;
}

static inline __attribute__((always_inline)) __attribute__((no_instrument_function)) u64 __get_unaligned_le64(const u8 *p)
{
 return (u64)__get_unaligned_le32(p + 4) << 32 |
        __get_unaligned_le32(p);
}

static inline __attribute__((always_inline)) __attribute__((no_instrument_function)) void __put_unaligned_le16(u16 val, u8 *p)
{
 *p++ = val;
 *p++ = val >> 8;
}

static inline __attribute__((always_inline)) __attribute__((no_instrument_function)) void __put_unaligned_le32(u32 val, u8 *p)
{
 __put_unaligned_le16(val >> 16, p + 2);
 __put_unaligned_le16(val, p);
}

static inline __attribute__((always_inline)) __attribute__((no_instrument_function)) void __put_unaligned_le64(u64 val, u8 *p)
{
...
# 15 "./arch/mips/include/asm/unaligned.h" 2
# 26 "./arch/mips/include/asm/unaligned.h"
