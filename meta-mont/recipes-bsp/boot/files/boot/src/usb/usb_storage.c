 ...
 */
//#define USB_MAX_XFER_BLK    65535 //EHCI driver not yet update
#define USB_MAX_XFER_BLK    32
#else
...
int usb_stor_scan(int mode)
{
    ...
    for (i = 0; i < USB_MAX_STOR_DEV; i++) {
        memset((void *) &usb_dev_desc[i], 0, sizeof(block_dev_desc_t));
...
static int usb_stor_CB_reset(struct us_data *us)
{
    ...
    memset((void *) cmd, 0xff, sizeof(cmd));
              ...
              block_dev_desc_t *dev_desc)
{
    ...
    memcpy((void *) &dev_desc->vendor[0], (void *) &usb_stor_buf[8], 8);
    memcpy((void *) &dev_desc->product[0], (void *) &usb_stor_buf[16], 16);
    memcpy((void *) &dev_desc->revision[0], (void *) &usb_stor_buf[32], 4);
    dev_desc->vendor[8] = 0;
