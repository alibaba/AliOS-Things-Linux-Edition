...
*   \brief USB Standard Descriptor Definition
*   \author
*/
/*
 * (C) Copyright 2003
...
#else
/*
    if not align 0x2, the address of struct maybe odd
    and destroy the feature of u16 which is align 0x2.
    bug happen at file => usb.c,
            usb_parse_config()
...
#else
/*
    if not align 0x4, the address of struct maybe odd
    and destroy the feature of u16 which is align 0x4.
*/
